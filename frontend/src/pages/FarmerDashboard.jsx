...
export default function FarmerDashboard() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--proof)', color: 'var(--sheet)', minHeight: '100vh', fontFamily: "'Instrument Sans', sans-serif", paddingTop: '80px' }}>
      {/* STATS SECTION */}
      ...
      {/* ADD FIELD SECTION */}
      <section className="band wrap" id="add-field-section" data-reveal style={{ marginBottom: '4rem' }}>
        <div className="head">
