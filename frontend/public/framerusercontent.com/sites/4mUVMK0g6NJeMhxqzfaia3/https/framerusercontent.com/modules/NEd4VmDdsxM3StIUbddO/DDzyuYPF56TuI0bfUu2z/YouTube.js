...
export function Youtube({
    ...
    if (!showVideo) { // if a browser does not support `loading=lazy`, make sure the video doesn't start playing in the background
    ...
    return /*#__PURE__*/ _jsxs("article", {
        ...
        style: { ...wrapperStyle,
            borderRadius,
            transform: // Safari sometimes struggles to render border-radius:
        ...
        }), showThumbnail && /*#__PURE__*/ _jsxs(_Fragment, {
        ...
        }), !onCanvas ? /*#__PURE__*/ _jsx("iframe", {
            loading: !showVideo ? "lazy" : undefined,
            style: !showVideo ? { ...videoStyle,
                display: "none"
            } : videoStyle,
            ...iframeProps
        }) : null, showVideo ? null : /*#__PURE__*/ _jsx(PlayButton, {
            onClick: startVideo,
            isHovered: isHovered,
            isRed: isRed
        })]
...
function getThumbnailURL(videoId, res) { // https://gist.github.com/a1ip/be4514c1fd392a8c13b05e082c4da363
